...
public class TrolleybusParkForm extends JFrame {
    ...
    String[] tabs = {"Drivers", "Transports", "Routes"};
    ...
    private JTable createRoutesTable(){
        return createTable("SELECT * FROM routes");
    }
    ...
    private void editForm(Integer index, Integer row){
        ...
        switch (selectedTab) {
            case 0: {
                ...
                JTextField experiences = index.equals(-1) ? new JTextField(10) : new JTextField(tables.get(selectedTab).getValueAt(row,3).toString(), 10);
                func(p1, new JLabel("Experiences"), 0, 2, 1, 1, true, gbc);
                func(p1, experiences, 1, 2, 4, 1, false, gbc);

                save.addActionListener(e -> {
                    try {
                        if (firstName.getText().equals("") || secondName.getText().equals("") || experiences.getText().equals(""))
                            throw new Exception();
                        if (Integer.valueOf(experiences.getText())<0)
                            throw new NumberFormatException();
                        if(index.equals(-1))
                            database.addNote("drivers", new Object[]{firstName.getText(), secondName.getText(), Integer.parseInt(experiences.getText())});
                        else
                            database.updateNote("drivers", new Object[]{firstName.getText(), secondName.getText(), Integer.parseInt(experiences.getText())}, index);
                        frame.dispose();
            ...
            case 1: {
                ...
                save.addActionListener(e->{
                    try{
                        ...
                        if(index.equals(-1))
                            database.addNote("trolleybuses", new Object[]{Integer.parseInt(number.getText()),
                                    Integer.parseInt(mileage.getText()),
                                    Integer.parseInt(productionYear.getText())});
                        else
                            database.updateNote("trolleybuses", new Object[]{Integer.parseInt(number.getText()),
                                    Integer.parseInt(mileage.getText()),
            ...
            case 2: {
                ...
                LinkedHashMap<Integer,Integer> transports = new LinkedHashMap<>();
                ...
                try {
                    ...
                    for (int i = 0; resultSet.next(); i++){
                        transports.put(resultSet.getInt(columnNames[1]),resultSet.getInt(columnNames[0]));
                ...
                JTextField numberRoute = index.equals(-1) ? new JTextField(10) : new JTextField(tables.get(selectedTab).getValueAt(row,1).toString(), 10);
                func(p1,new JLabel("Number route"),0,0,1,1,true, gbc);
                func(p1,numberRoute,1,0,4,1,true, gbc);
                ...
                JTextField date = index.equals(-1) ? new JTextField("2018-01-01",10) : new JTextField(tables.get(selectedTab).getValueAt(row,3).toString(), 10);
                ...
                save.addActionListener(e->{
                    try{
                        if(numberRoute.getText().equals("")  || date.getText().equals(""))
                            throw new Exception();
                        if(index.equals(-1))
                            database.addNote("routes", new Object[]{Integer.parseInt(numberRoute.getText()),
                                    drivers.get(driver.getSelectedItem()),
                                    transports.get(Integer.parseInt(trolleybus.getSelectedItem().toString())),
                                    date.getText()});
                        else
                            database.updateNote("routes", new Object[]{Integer.parseInt(numberRoute.getText()),
                                    drivers.get(driver.getSelectedItem()),
                                    transports.get(Integer.parseInt(trolleybus.getSelectedItem().toString())),
                                    date.getText()}, index);
                        frame.dispose();
